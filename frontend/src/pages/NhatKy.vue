  ...
  <div class="page-container">
    ...
    <el-card shadow="never" class="filter-card">
      <el-row :gutter="12" align="middle">
        ...
        <el-col :span="5">
          <el-select v-model="filterAction" placeholder="Tất cả hành động" clearable class="w-full" @change="fetchLogs">
        ...
        <el-col :span="5">
          <el-select v-model="filterEntityType" placeholder="Tất cả đối tượng" clearable class="w-full" @change="fetchLogs">
