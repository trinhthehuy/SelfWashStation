'Bổ sung liên kết đại lý vào bảng Token API
...
1. Loại bỏ dữ liệu ảnh (Avatar) khỏi danh sách đại lý
...
2. Tối ưu câu lệnh đếm (Count) cho Trạm
